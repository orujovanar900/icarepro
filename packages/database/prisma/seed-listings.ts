    ...
    const listings = await Promise.all([
        prisma.listing.create({
            data: {
                ...
                lat: 40.3777 + (Math.random() - 0.5) * 0.004,
                lng: 49.8478 + (Math.random() - 0.5) * 0.004,
                floor: 12,
                totalFloors: 20,
                area: 180,
                basePrice: 3200,
        ...
        prisma.listing.create({
            data: {
                ...
                lat: 40.3920 + (Math.random() - 0.5) * 0.004,
                lng: 49.8300 + (Math.random() - 0.5) * 0.004,
                floor: 7,
                totalFloors: 16,
                area: 95,
                rooms: 3,
        ...
        prisma.listing.create({
            data: {
                ...
                lat: 40.4070 + (Math.random() - 0.5) * 0.004,
                lng: 49.8530 + (Math.random() - 0.5) * 0.004,
                floor: 1,
                totalFloors: 5,
                area: 120,
                basePrice: 2500,
        ...
        prisma.listing.create({
            data: {
                ...
                lat: 40.3750 + (Math.random() - 0.5) * 0.004,
                lng: 49.8800 + (Math.random() - 0.5) * 0.004,
                floor: 4,
                totalFloors: 9,
                area: 72,
                rooms: 2,
        ...
        prisma.listing.create({
            data: {
                ...
                lat: 40.3627 + (Math.random() - 0.5) * 0.004,
                lng: 49.8395 + (Math.random() - 0.5) * 0.004,
                floor: 8,
                totalFloors: 22,
                area: 260,
                basePrice: 4800,
